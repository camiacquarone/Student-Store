...
Yes, the topics discussed in my labs helped me prepare complete the assignement. For next time I would have liked to follow the format of the instructor demo code. I felt unprepared connecting the frontend and the backend because the instructions were not clear. 

* If you had more time, what would you have done differently? Would you have added additional features? Changed the way your project responded to a particular event, etc.
  
I would have loved to have more time to implement the stretch features. They are useful and enhance the user experience. 
